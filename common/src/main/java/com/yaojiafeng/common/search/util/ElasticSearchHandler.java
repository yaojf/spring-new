...
import com.yaojiafeng.common.search.entity.DataFactory;
...
public class ElasticSearchHandler {
    ...
    public ElasticSearchHandler(String ipAddress) {
         ...
         */
        client = TransportClient.builder().build().addTransportAddress(new InetSocketTransportAddress(new InetSocketAddress(ipAddress, 9300)));
    }
